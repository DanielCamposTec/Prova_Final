<%-- 
    Document   : index
    Created on : 9 de nov. de 2022, 11:32:06
    Author     : DellG5
--%>
...
<html>
    ...
    <body>
        ...
        <section class="box">
            <h2 class="venda">Notebooks à Venda</h2>
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                %>
                  ...
                  <section class="box">
                      <h2 class="aluguel">Aluguel de Notebooks</h2>
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <%
                try{
                    Class.forName("org.postgresql.Driver");
                    ...
                    <div class="col">
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <p class="card-text"><%=rs.getString("descricao") %></p>
                            <hr>
                            <p style="color:red;font-size:20px;text-align:center;">R$<%=rs.getString("valormensal")%></p>
                            <button class="btn btn-warning" style="width:100%;">Alugar</button>
                          </div>
                        </div>
                      </div>
                <%    }
