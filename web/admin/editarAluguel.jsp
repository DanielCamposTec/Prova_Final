<%-- 
    Document   : editarAluguel
    Created on : 5 de dez. de 2022, 21:05:55
    Author     : DellG5
--%>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Gerenciar Locação</li>
                        </ol>
                    </div>
                    <%
                        ...
                        try {
                            ...
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    ...
                                    <form action="config/editarAluguel.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="form-label">Nome do produto</label>
                                            <input type="text" class="form-control" value="<%=rs.getString("nome")%>" name="nome" placeholder="Produto Alugado"/> 
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<%=rs.getString("valormensal")%>" name="valor" placeholder="Valor da mensalidade"/> 
                                        </div>
                                        <div class="mb-3">
